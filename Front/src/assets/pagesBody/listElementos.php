...
<section class="content-header">
    <h1>
    <i class="fa fa-industry"></i> Mantenimiento de Elementos <?php echo ($_SESSION['tipo']);?>
        <small>Consulte aquí los Elementos</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href=" "><i class="fa fa fa-home"></i> Inicio</a></li>
        <li class="active">Elementos</li>
        <a target='_blank' href="../img/ayuda/listElementos.jpg" imageanchor="1" style="margin-left: auto; margin-right: auto;">  |  <i class="fa fa-question-circle text-blue "></i> Ayuda</a>
    </ol>
</section>
                    ...
                    <!-- encabezado -->
                        ...
                        <?php foreach($arrayC as $array){?>
                                ...
                                <!--$array->item el item hace referencia al nombre del atributo item de la consulta la base de datos-->
                                    ...
                                    <td><a href="../_controlador/ElementoController.php?accion=consultar&subaccion=edit&placa=<?php echo $array->placa; ?>" class="small-box-footer"><i class="fa fa-pencil"></i></a></td>
                                    <td><a href="../_controlador/ElementoController.php?accion=eliminar&placa=<?php echo $array->placa; ?>" class="small-box-footer"><i class="fa fa-remove"></i></a></td>
                                </tr>                    
                                <?php } ?>
                        </tbody>
                    </table>
