    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                <a href="#"><i class="fa fa-circle text-success"></i> Cuentadante</a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                <a href="../_controlador/ElementoController.php?accion=mostrarElementosPorCuentadante&id=<?php echo ($_SESSION['usuarioLogin']->getId()) ?>&nombres=<?php echo ($_SESSION['usuarioLogin']->getNombres()) ?>&apellidos=<?php echo ($_SESSION['usuarioLogin']->getApellidos()) ?>">
                <i class="fa fa-cubes"></i> <span>Mis Elementos </span>
                    <span class="pull-right-container"><small class="label pull-right bg-blue">Asociados</small></span>
                </a>
            </li>
            ...
            <li>
                <a href="../_controlador/UsuarioController.php?accion=mostrarPrestDelUsuarioParaFuncionario&id=<?php echo ($_SESSION['usuarioLogin']->getId()) ?>&nombres=<?php echo ($_SESSION['usuarioLogin']->getNombres()) ?>&apellidos=<?php echo ($_SESSION['usuarioLogin']->getApellidos()) ?>">
                    <i class="fa fa-shopping-cart"></i></i> <span>Mis Préstamos </span>
            ...
            <li>
                ...
                <i class="fa fa-pie-chart"></i></i> <span>Consumos </span>
                    <span class="pull-right-container">
                    <small class="label pull-right bg-green">Disponibles</small>
                    </span>
                </a>
            </li>
